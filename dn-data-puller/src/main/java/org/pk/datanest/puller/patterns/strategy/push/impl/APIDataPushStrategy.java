...
@Service("apiDataPushStrategy")
@Primary
public class APIDataPushStrategy extends PushStrategy<Map<String, String>, Object> implements StatusNotifier {

    Logger logger = LoggerFactory.getLogger(APIDataPushStrategy.class);
